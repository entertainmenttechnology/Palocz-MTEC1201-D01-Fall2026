## Due before class on Friday, 9/18
...
* At least 3 different types of shapes.  
* Variation in stroke weight
* Variation in fill color.
...
Save the completed sketch as "SS1_[FirstName + Last Initial]" (for example, "SS1_AlexandraP"). Push to your Class GitHub Repo **before the beginning of our next class**, and also have the sketch ready to show for that class. (If you missed the GitHub setup portion of class, check out the GitHub getting started instructions [here](https://github.com/entertainmenttechnology/Palocz-MTEC1201_D02-Spring2026/blob/main/resources/github%20instructions.md))
