...
## Setting up GitHub: Instructions for Newbies    
...
1. **Create a new repository**, locally and online, titled MTEC1201_FirstName (for example: MTEC1201_Alexandra). 

2. **Send me your GitHub user name on Discord.**
  
3. **Go through all past assignments and re-label as needed**, with the short study # and title (SS#_Title), making sure that each project is contained within appropriatelty named folder, as outlined above.
