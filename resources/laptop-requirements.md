...
Emerging Media students are not required to own a laptop computer, but it is highly recommended. The computer should be Mac or Windows only and should adhere to the minimum or recommended specs below.         
While we have older model Mac laptops available for checkout in the classroom, I recommend bringing your own laptop for the sake of easier file management and smoother workflow. 
